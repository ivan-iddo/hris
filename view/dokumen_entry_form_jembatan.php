  ...
  <div class="panel-group accordion" id="accordion">
    ...
    <div class="box-body">
      <form class="form-horizontal" method="post" action="http://sikumis.binamarga.pu.go.id/survey_data/save_atribut_khusus">
        ...
        <div class="form-group">
            <label class="control-label col-sm-2" id="title-ruas">Jembatan</label>
            <div class="col-sm-5">

              <!-- select ruas -->
              <div id="div-sel-ruas">
                <select id="f_jembatan" class="form-control select2 select2-hidden-accessible" id="cmb-ruas" name="ruas_data" style="width:100%" tabindex="-1" aria-hidden="true" onChange="getJembatanData(this.value)">
                </select>
                  </div>
            </div>
            <div class="col-sm-4">
               <div class="btn btn-xs btn-default btn-success" id="frmJembatan">Tambah Jembatan Baru</div>
            </div>
        </div>
        ...
        <div class="form-group" id="group-nomor" style="display: block;">
            <label class="control-label col-sm-2">Nomor Jembatan </label>
            <div class="col-sm-9">
        ...
        <div class="form-group" id="group-nama" style="display: block;">
            <label class="control-label col-sm-2">Nama Jembatan</label>
            <div class="col-sm-9">
...
$.ajax({
  ...
  function gotoatribute(){ 
    ...
    var message;
             ...
             function simpan2(){
                  ...
                  selectedRows.forEach( function(selectedRow, index) {
                    ...
                    selectedRowsString += selectedRow.id;
                        ...
                        var id_jembatan = $('#f_jembatan').val();
                        
                        if(selectedRowsString ==''){
                          onMessage("Silahkan Pilih data dari tabel atribut utama dulu!");
                           ...
                           var datas = {
                                   ...
                                   f_provinsi:f_provinsi,
                                   id:id,
                                   id_atribut:id_atribut,id_ruas:id_ruas,
        ...
        // setup the grid after the page has finished loading 
           ...
           new agGrid.Grid(gridDiv1, gridOptions1);
             ...
             var columnDefs = [
           {headerName: "No", field: "no", width: 100, filterParams:{newRowsAction: 'keep'}} ,
           {headerName: "Nomor Jembatan", field: "nomor_jalan", width: 300, filterParams:{newRowsAction: 'keep'}},
           {headerName: "Nama Jembatan", field: "nama", width: 200, filterParams:{newRowsAction: 'keep'}},
    ...
    selectedRows.forEach( function(selectedRow, index) {
      ...
      success: function( data, textStatus, jQxhr ){
        ...
        $("#panjang_penanganan").val(data[0].panjang_penanganan);
         ...
         getOptionsEdit("f_jembatan",BASE_URL+"ruas_jembatan/optiondata?id="+data[0].id_ruas,data[0].id_jembatan);
    ...
    function getJembatanData(a){
       $.ajax({
                                   url: BASE_URL+'ruas_jembatan/getuser/?id='+a,
                                   headers: {
                                       'Authorization': localStorage.getItem("Token"),
                                       'X_CSRF_TOKEN':'donimaulana',
                                       'Content-Type':'application/json'
    ...
    function getRuasData(a){
      getOptions("f_jembatan",BASE_URL+"ruas_jembatan/optiondata?id="+a);
    }
    
     $('#frmJembatan').on('click', function(){
           ...
           input +='<label class="col-sm-3 control-label">Provinsi<\/label>';
           input +='<div class="col-sm-5">';
           input +='<select name="f_provinsi" id="f_provinsi" class="form-control" onChange="carijalan(this.value)"/></select>';
           input += '<\/div>';
           input += '<\/div>';
           
            input +='<div class="form-group">';
           input +='<label class="col-sm-3 control-label">Ruas Jalan<\/label>';
           input +='<div class="col-sm-5">';
           input +='<select name="id_jalan" id="id_jalan" class="form-control"/></select>';
           input += '<\/div>';
           input += '<\/div>';
           ...
           input +='<\/form>';
                ...
                bootbox.dialog({
                   title: "<i class=\"fa fa-user\"><\/i> Tambah Ruas Jembatan",
                   message:input, 
                   animateIn: 'bounceIn',
                   animateOut : 'bounceOut',
                   buttons: {
     ...
     function simpan_jembatan(action){
                       var  nama      = $("#f_nama").get(0).value; 
                       var f_id_edit = $("#f_id_edit").get(0).value;
                       var f_user_edit     = $("#f_user_edit").get(0).value;
                       f_link_id = $("#f_link_id").get(0).value;
                       ...
                       if(nama==""){
                           ...
                           onMessage("Ruas Jalan Wajib Diisi!");
                           $("#id_jalan").focus();
                        }else if(f_link_id==""){
                           onMessage("Kode Arsip tidak boleh kosong");
                           $("#f_kode_arsip").focus();
                           ...
                           if(action == 'add'){
                               URL = BASE_URL+"ruas_jembatan/save";
                           }else if(action == 'edit'){
                               URL = BASE_URL+"ruas_jembatan/edit";
                           }
						...
						success: function( data, textStatus, jQxhr ){
                                ...
                                message=data.message; 
                                   if(hasil=="success"){         
                                            ...
                                            getOptions("f_jembatan",BASE_URL+"ruas_jembatan/optiondata?id="+$('#f_ruasjalan').val());
                                               $.niftyNoty({
                                                               type: 'success',
                                                               title: 'Success',
                                                               message: message,
