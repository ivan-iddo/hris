  ...
  <div class="tab-base">
    ...
    <ul class="nav nav-tabs">
      ...
      <li class="active"><a data-toggle="tab" href="#demo-lft-tab-2">Form Tipe Dokumen</a></li>
...
//<![CDATA[
        ...
        // setup the grid after the page has finished loading 
           ...
           function loaddata(){
           $.ajax({
                                   url: BASE_URL+'tipe_dokumen/list',
                                   headers: {
           ...
           submit_get(BASE_URL+'tipe_dokumen/delete/?id='+selectedRowsString,loaddata);
           ...
           selectedRows.forEach( function(selectedRow, index) {
               ...
               $.ajax({
                                   url: BASE_URL+'tipe_dokumen/getuser/?id='+selectedRowsString,
                                   headers: {
                                       'Authorization': localStorage.getItem("Token"),
                                       'X_CSRF_TOKEN':'donimaulana',
                                       'Content-Type':'application/json'
          ...
          input += '<\/div>';
           ...
           input +='<\/form>';
                ...
                bootbox.dialog({
                   title: "<i class=\"fa fa-user\"><\/i> Tambah Tipe Dokumen",
                   message:input, 
                   animateIn: 'bounceIn',
                   animateOut : 'bounceOut',
                   buttons: {
             ...
             function simpan(action){
                       ...
                       if(nama==""){
                           ...
                           if(action == 'add'){
                               URL = BASE_URL+"tipe_dokumen/save";
                           }else if(action == 'edit'){
                               URL = BASE_URL+"tipe_dokumen/edit";
                           }
