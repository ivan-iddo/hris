<form id="form-mutasi"  method="post" role="form" class="form-horizontal pad-all">
	<div class="row pad-all">
		<div class="col-lg-5">
			...
			<input type="text" name="statusproses" id="statusproses" style="display:none" value="91">
			<div class="form-group">
...
<div class="form-group">
	...
	<a style="margin-left:3px" class="btn btn-success mar-all" onclick="prosesmutasi()"><i class="fa fa-file-excel-o"></i> Setujui Kirim Ke SDM</a>
</div>  
