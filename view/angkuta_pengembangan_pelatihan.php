...
$('.judul-menu').html('Master Alat Angkut');
    //<![CDATA[
    // specify the columns
    var columnDefs = [
    ...
    function loaddata(jml = 0) {
        ...
        $.ajax({
            url: BASE_URL + 'angkutan_pengembangan_pelatihan/list/' + jml + '/' +search,
            headers: {
    ...
    function proses_delete() {
        ...
        if (selectedRows == '') {
            ...
            submit_get(BASE_URL + 'angkutan_pengembangan_pelatihan/delete/?id=' + selectedRowsString, loaddata);
        }
    }
    ...
    function proses_edit() {
        ...
        if (selectedRows == '') {
            ...
            $.ajax({
                url: BASE_URL + 'angkutan_pengembangan_pelatihan/get/?id=' + selectedRowsString,
                headers: {
                    'Authorization': localStorage.getItem("Token"),
                    'X_CSRF_TOKEN': 'donimaulana',
                    'Content-Type': 'application/json'
            ...
            bootbox.dialog({
                ...
                message: $('<div></div>').load('view/pengembangan_pelatihan/add_alat.php'),
                animateIn: 'bounceIn',
