...
<script charset="utf-8" type="text/javascript">
    ...
    function loaddata(jml = 0) {
        ...
        $.ajax({
            url: BASE_URL + 'pengembangan_pelatihan_kegiatan/list/' + jml + '/' +search,
            headers: {
    ...
    function proses_delete() {
        ...
        if (selectedRows == '') {
            ...
            submit_get(BASE_URL + 'pengembangan_pelatihan_kegiatan/delete/?id=' + selectedRowsString, loaddata);
        }
    }
    ...
    function proses_edit() {
        ...
        if (selectedRows == '') {
            ...
            $.ajax({
                url: BASE_URL + 'pengembangan_pelatihan_kegiatan/get/?id=' + selectedRowsString,
                headers: {
                    'Authorization': localStorage.getItem("Token"),
                    'X_CSRF_TOKEN': 'donimaulana',
                    'Content-Type': 'application/json'
            ...
            bootbox.dialog({
                ...
                message: $('<div></div>').load('view/pengembangan_pelatihan_kegiatan/add.php'),
                animateIn: 'bounceIn',
