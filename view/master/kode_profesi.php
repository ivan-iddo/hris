...
<script type="text/javascript" charset="utf-8">
  ...
  var columnDefs_m_kode_profesi =  [{headerName: "kd profesi", field: "kd_profesi", width: 190, filterParams:{newRowsAction: "keep"}},{headerName: "ds profesi", field: "ds_profesi", width: 190, filterParams:{newRowsAction: "keep"}},{headerName: "kd grp job profesi", field: "kd_grp_job_profesi", width: 190, filterParams:{newRowsAction: "keep"}},];
  ...
  function delete_m_kode_profesi(){
    var idcell = getGridId(gridOptions_m_kode_profesi,'kd_profesi');
    if(!empty(idcell)){
