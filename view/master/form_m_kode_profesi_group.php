<form id="form-m_kode_profesi_group"  method="post" role="form" class="form-horizontal pad-all">
...
<script>
 ...
 $('#id').val(idcell);
    ...
    window.setTimeout(function(){
        ...
        getJson(getdata_m_kode_profesi_group, url_api+'listdata?id='+idcell);
    }
    },500);
    


function getdata_m_kode_profesi_group(result){
