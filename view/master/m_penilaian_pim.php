...
?>
<?php 
   $query= mysqli_query($con,'SELECT count(m_penilaian_kpi.id_grup) as jml, sum(his_kpi_detail.bobot) as bobot_kpi FROM m_penilaian_kpi LEFT JOIN his_kpi_detail ON m_penilaian_kpi.id_grup=his_kpi_detail.id_kegiatan where m_penilaian_kpi.kode=96 and m_penilaian_kpi.child=17 and m_penilaian_kpi.tampilkan="1"');
