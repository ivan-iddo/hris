...
<script type="text/javascript" charset="utf-8">
  ...
  function delete_m_kode_profesi_group(){
    var idcell = getGridId(gridOptions_m_kode_profesi_group,'kd_grp_job_profesi');
    if(!empty(idcell)){
