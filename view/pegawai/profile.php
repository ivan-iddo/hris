                    ...
                    <li class="active">
                        ...
                        <li>
                            <a data-toggle="tab" href="#demo-lft-tab-1b" onclick="tabKeluarga();"><span
                                class="block text-center text-success"><i class="fa fa-group fa-2x"></i></span>
                            Keluarga</a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#demo-lft-tab-2a" onclick="tabPendidikan();"><span
                                class="block text-center text-success"><i
                                class="fa fa-graduation-cap fa-2x"></i></span> Pendidikan</a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#demo-lft-tab-3a" onclick="tabPelatihan();"><span
                                    class="block text-center text-success"><i class="fa fa-briefcase fa-2x"></i></span>
                                Pelatihan</a>
                            </li>
                            <li>
