<form id="form-mutasi"  method="post" role="form" class="form-horizontal pad-all">
	<div class="row pad-all">
		<div class="col-lg-5">
			...
			<input type="text" name="statusproses" id="statusproses" style="display:none" value="88">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<textarea placeholder="" class="form-control input-sm" id="keterangan" name="keterangan" type="text">
										...
										<div class="form-group">
											...
											<a style="margin-left:3px" class="btn btn-success mar-all" onclick="prosesmutasi()"><i class="fa fa-file-excel-o"></i> Kirim Ulang Ke Direksi</a>
										</div>  
