<form name="form-file-upload-tugas" id="form-file-upload-tugas" class="form-horizontal">
...
<script> function upload_file2() {
	...
	var data = formJson('form-file-upload-tugas');
