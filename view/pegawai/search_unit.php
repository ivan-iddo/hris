...
//<![CDATA[
        ...
        function loaddata(jml){
          ...
          var url = BASE_URL + 'kpi/mpenilaian/listuser_uk/' + search + '/' + jml;
          
          if($('#searchPegawai').val() !==''){
            search = $('#searchPegawai').val();
            url = BASE_URL + 'kpi/mpenilaian/listuser_uk/' + search + '/' + jml ;
          }
          
          if ((group !== '1') && (group !== '6')) {
            url = BASE_URL + 'kpi/mpenilaian/listuser_uk/' + search + '/' + jml + "/" + group;
          }
          $.ajax({
           url: url,
           headers: {
