<form name="form-file-upload-skp" id="form-file-upload-skp" class="form-horizontal">
...
<script> function upload_file2() {
	...
	var data = formJson('form-file-upload-skp');
