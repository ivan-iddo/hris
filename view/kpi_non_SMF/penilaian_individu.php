                    ...
                    <form class="form-horizontal  pad-all" name="form-pi" id="form-pi" method="post">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input disabled id="nip" name="nip" class="form-control" type="text"
                                           style="width:100px">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mar-btm">
                                        <input disabled style="width:150px" name="nama_pegawai" id="nama_pegawai"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mar-btm">
                                        <input name="akhir" id="akhir" placeholder="Search" class="form-control"
                                               type="date">
                        ...
                        <div class="row">
                            <div class="col-sm-9 text-left">
                                <a href="javascript:void(0)" class="btn btn-mint" id="simpan" name="simpan"
                                   type="submit" onClick="simpanPI();return false;">Save</a>
                            </div>
                            <div class="col-sm-9 text-left buttoenedit">
                                <a href="javascript:void(0)" class="btn btn-warning" id="edit" name="edit" type="submit"
                                   onClick="simpanPI();return false;">Edit</a>
                                <a href="javascript:void(0)" class="btn btn-mint" id="simpan" name="simpan"
                                   type="submit"
                                   onClick="$('#simpan').show('slow');$('.buttoenedit').hide('slow');document.getElementById('form-pi').reset(); return false;">Buat
                                    Baru</a>
                ...
                <div class="panel-body">
                    <div class="dataTables_filter" id="demo-dt-addrow_filter" style="margin-right:5px">
                        <label>Search:<input aria-controls="demo-dt-addrow" class="form-control input-sm" placeholder=""
                                             ...
                                             onkeydown="if(event.keyCode=='13'){loadDataPI(0);}"></label>
...
<button class="btn btn-primary btn-icon mar-all" onclick="getRowData()"><i class="fa fa-folder icon-2x"></i> SAVE KPI
</button>
<button class="btn btn-success btn-icon mar-all" onclick="downloadKPI()"><i class="fa fa-cloud-download icon-2x"></i>
    Download KPI
</button>
