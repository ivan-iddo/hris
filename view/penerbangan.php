<?php
$nama_modul='penerbangan';
$judul1="Maskapai Penerbangan";
$judul2="Detail Penerbangan";
?>
<div class="tab-base">
  <!--Nav Tabs-->
  ...
  function proses_edit(){
    ...
    // alert('>>'+selectedRows+'<<<');
    if(selectedRows == ''){
      onMessage('Silahkan Pilih Data <?php echo $judul1?> Terlebih dahulu!');
      return false;
    }
    else{
      var selectedRowsString = '';
  ...
  function proses_edit_item(){
    ...
    // alert('>>'+selectedRows+'<<<');
    if(selectedRows == ''){
      onMessage('Silahkan Pilih Item <?php echo $judul2?> Terlebih dahulu!');
      return false;
    }
    else{
      var selectedRowsString = '';
      ...
      input +='</form>';
      bootbox.dialog({
        title: "<i class=\"fa fa-users\"></i> Edit <?php echo $judul2?>",
        message:input, 
        animateIn: 'bounceIn',
        animateOut : 'bounceOut',
        buttons: {
  ...
  $('#demo-bootbox-bounce').on('click', function(){
    var input='<form class="form-horizontal" id="form-upload" name="form-upload" method="post" enctype="multipart/form-data">';
    input += '<div class="panel-body">';
    input +='<div class="form-group">';
    input +='<label class="col-sm-3 control-label" for="demo-hor-inputemail">Nama</label>';
    input +='<div class="col-sm-5">';
