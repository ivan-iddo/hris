                        ...
                        <div class="pad-btm form-inline" style="border-top:1px solid #dedede;padding:10px">
					            <div class="row">
					                <div class="col-sm-6 table-toolbar-left">
					                    <button id="demo-btn-addrow" class="btn btn-purple" onclick="addKualifikasi()"><i class="demo-pli-add"></i> Tambah Kebutuhan SDM</button>
                                        <button style="margin-left:3px" class="btn btn-mint" onclick="edittk()"><i class="fa fa-file-excel-o"></i> Edit</button>
                                        <button class="btn btn-danger" onclick="hapustk()"><i class="fa fa-file-excel-o"></i> Delete</button>
					                ...
					                <div class="col-sm-6 table-toolbar-right">
					                    ...
					                    <div class="btn-group">
                                        <button class="btn btn-default btn-sm" style="border-radius:0px !important" onClick="inbox();return false;"><i class="fa fa-download"></i>  Inbox </button>
...
{headerName: "lain lain", field: "lain_lain", width: 190, filterParams:{newRowsAction: "keep"}},
		 ...
		 // setup the grid after the page has finished loading 
			...
			new agGrid.Grid(gridDiv,gridTK);
			 ...
			 function listFromtk(){
			   ...
			   var uri = BASE_URL+'abk/abk/listtk?year='+thn;
			   if(empty(thn)){
				 var d = new Date();
				 var n = d.getFullYear();
				   thn = n;
			   ...
			   if(!empty(thn)){
				   uri = BASE_URL+'abk/abk/listtk?year='+thn+'&id_uk='+uk;
			   }
		   ...
		   function searchtk(){
			 ...
			 var uri = BASE_URL+'abk/abk/listtk?year='+thn+'&id_uk='+uk; 
			  if(empty(thn)){
  ...
  function adddetail(){
    var selectedRows = gridTK.api.getSelectedRows();
           ...
           gopop('view/abk/form_detail_pengajuan.php',detailaction,'large');
  ...
  function alasan(){
    var selectedRows = gridTK.api.getSelectedRows();
           ...
           gopop('view/abk/form_detail_alasan.php',alasanaction,'large');
...
return false;
  ...
  function edittk(){
    var selectedRows = gridTK.api.getSelectedRows();
           ...
           gopop('view/abk/add_form_kulifikasi.php',editaction,'large');
...
return false;
  ...
  function inbox(){
    var selectedRows = gridTK.api.getSelectedRows();
           ...
           gopopOnly('view/abk/inbox.php',detailaction,'medium');
