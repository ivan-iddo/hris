<?php $namaControler='ruas_jembatan';?> 
<div class="tab-base">
  <!--Nav Tabs-->
  ...
  <ul class="nav nav-tabs">
    ...
    <li class="active"><a data-toggle="tab" href="#demo-lft-tab-2">Form Ruas Jembatan</a></li>
...
//<![CDATA[
           // specify the columns
           var columnDefs = [
           {headerName: "Kode Jalan", field: "link_id", width: 100, filterParams:{newRowsAction: 'keep'}} ,
           {headerName: "Kode Jembatan", field: "id", width: 160, filterParams:{newRowsAction: 'keep'}} ,
           {headerName: "Nama Jembatan", field: "nama", width: 300, filterParams:{newRowsAction: 'keep'}},
           ...
           {headerName: "Panjang Jembatan (Km)", field: "panjang_ruas", width: 150, filterParams:{newRowsAction: 'keep'}},
        ...
        new agGrid.Grid(gridDiv, gridOptions);
           ...
           function proses_delete(){
            ...
            // alert('>>'+selectedRows+'<<<');
            if(selectedRows == ''){
             onMessage('Silahkan Data Ruas jembatan Terlebih dahulu!');
             return false;
           }else{
          ...
          var selectedRows = gridOptions.api.getSelectedRows();
            ...
            $.ajax({
             ...
             success: function( res, textStatus, jQxhr ){
               ...
               getOptionsEdit("id_jalan",BASE_URL+"ruas_jalan/optiondata?id="+res[0].id_propinsi,res[0].id_jalan);
            ...
            bootbox.dialog({
             title: "<i class=\"fa fa-users\"><\/i> Edit Ruas Jembatan",
             message:input, 
             animateIn: 'bounceIn',
...
function carijalan(a){
  getOptions("id_jalan",BASE_URL+"ruas_jalan/optiondata?id="+a);
}
