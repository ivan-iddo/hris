...
<?php if(($_SESSION['data']['_pnc_id_jab']=='1345') OR ($_SESSION['data']['_pnc_id_jab']=='2553')OR ($_SESSION['data']['_pnc_id_jab']=='3')OR ($_SESSION['data']['_pnc_id_jab']=='2663')OR ($_SESSION['data']['_pnc_id_jab']=='2642')){?><?php }else{?>
<div class="row">
	<div class="col-sm-8 table-toolbar-left">
...
<script>
  ...
  {headerName: "Nilai IKP Awal", field: "nilai_awal", width: 130, filterParams:{newRowsAction: "keep"}},
   ...
   var gridTK = {
    ...
    function getkpi(){
      var selectedRows = gridTK.api.getSelectedRows();
            ...
            bootbox.dialog({ 
             message:$('<div></div>').load('view/kpi/listkpi.php?id=17&awal='+nilai_awal+'&akhir='+nilai+'&pid='+selectedRowsString),
             animateIn: 'bounceIn',
 ...
 function listFromtk(){
  ...
  var uri = BASE_URL+'kpi/mpenilaian/listiki?tahun='+thn+'&status=17';
  if(empty(thn)){
   var d = new Date();
   var n = d.getFullYear();
   thn = n;
 ...
 if(!empty(thn)){
   uri = BASE_URL+'kpi/mpenilaian/listiki?tahun='+thn+'&id_uk='+uk+'&status=17';
 }
