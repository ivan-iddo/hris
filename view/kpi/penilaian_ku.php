        ...
        // setup the grid after the page has finished loading 
           ...
           selectedRows.forEach( function(selectedRow, index) {
               ...
               nama_group += selectedRow.nama_group;
                        ...
                        getJson(prosesData,BASE_URL+'kpi/mpenilaian/getitemkpi?id=16&pid='+selectedRowsString);
           }
...
function tektok(){
    ...
    var selectedRowsString = '';
           ...
           getJson(prosesData,BASE_URL+'kpi/mpenilaian/getitemkpi?child=16&pid='+selectedRowsString);
}
...
function loadData(){
 getJson(prosesData,BASE_URL+'kpi/mpenilaian/getitemkpi?child=16&kod=95');
}
