...
require_once('connectdb.php');
       ...
       if(empty($_SESSION['userdata'])){
			header("Location: http://localhost:8888/hrd01/index.html");
		 }
?>
<html lang="en">
...
<head>
    ...
    <title>Admin</title>
    <link rel="icon" type="image/x-icon" href="http://localhost:8888/hrd01/ico.png" />
...
<link href="themes/default3/js/daterangepicker.css" rel="stylesheet">
