...
function editKeluarga(){
            ...
            if(selectedRows == ''){
               ...
               $('#txtTptLahir').val(data.tpt_lahir);
               $('#txtNik').val(data.NIK);
               $('#txtTglLahir').val(data.tgl_lahir);
               $('#id_keluarga').val(data.id);
                                             
               getOptionsEdit("txtKelamin",BASE_URL+"master/kelamin",data.kelamin);
               getOptionsEdit("txtPendidikan",BASE_URL+"master/pendidikan",data.pendidikan);
               getOptionsEdit("txtPekerjaan",BASE_URL+"master/pekerjaan",data.pekerjaan);
               getOptionsEdit("txtHubungan",BASE_URL+"master/hubkeluarga",data.hubkel);
