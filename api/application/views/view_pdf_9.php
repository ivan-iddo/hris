...
<table border="0" class="table-1" style="margin:15px">
	...
	<tr>
      <td colspan="3">
	  <p align="justify">      Biaya yang berkaitan dengan pelaksanaan tugas dibebankan pada Daftar Isian Pelaksanaan Anggaran (DIPA) Rumah Sakit Jantung dan Pembuluh Darah Harapan Kita, <?php echo $result["target_kinerja"]; ?></p>
      ...
      <td colspan="3">
        <table width="100%" border="0" cellpadding="3">
              ...
              <tr>
				...
				<td width="98%" valign="top">
					<p align="justify">Melaporkan penggunaan biaya ke Sub. Bag Perbendaharaan paling lambat 5 hari kerja setelah kegiatan dengan persetujuan dari PPK.</p>          
                </td>
              </tr>
              <tr>
                <td width="2%" valign="top">
