    ...
    <tr>
      <td colspan="3">
        <table width="100%" border="0px" cellpadding="1" cellspacing="0" class="table2" style="margin-top: 15px">
          <tr>
		    <th rowspan="2" align="center" width="25%">Jenis Pegawai</th>
            <th rowspan="2" align="center" width="1%"></th>
            <th rowspan="2" align="center" width="2%"></th>
            <th rowspan="2" align="center" width="13%">Jenis Kegiatan</th>
            <th colspan="2" align="center" width="9%">Durasi</th>
          ...
          <?php if (!empty($result)): ?>
            <?php foreach ($result as $key => $val): ?>
              <tr>
			    <td valign="top" align="center"><?php echo $val["profesi"]; ?></td>
			    <td></td>
