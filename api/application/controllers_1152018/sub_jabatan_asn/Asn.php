        ...
        if (array_key_exists('Authorization', $headers) && !empty($headers['Authorization'])) {
            ...
            if ($decodedToken != false) {
				...
				if(!empty($this->input->post('id_sub_jabatan_asn'))){
					...
					$arr=array('kd_jabatan'=> $this->input->post('kd_jabatan'),'ds_jabatan'=> $this->input->post('ds_jabatan'),'level_job'=> $this->input->post('level_job'),'detil'=> $this->input->post('detil'),'kd_jab_induk'=> $this->input->post('kd_jab_induk'),'kd_grp_job_profesi'=> $this->input->post('kd_grp_job_profesi'),'kd_group_grade'=> $this->input->post('kd_group_grade'),'ringkasan_jabatan'=> $this->input->post('ringkasan_jabatan'),'wewenang_jabatan'=> $this->input->post('wewenang_jabatan'),'kd_pendidikan'=> $this->input->post('kd_pendidikan'),'kd_jbt_pengalaman'=> $this->input->post('kd_jbt_pengalaman'),'lama_kd_jbt_pengalaman'=> $this->input->post('lama_kd_jbt_pengalaman'),'real_value'=> $this->input->post('real_value'),'kd_profesi'=> $this->input->post('kd_profesi'),'jab_aktif'=> $this->input->post('jab_aktif'),'periode_jab'=> $this->input->post('periode_jab'),'fung_struk'=> $this->input->post('fung_struk'),'kd_lokasi'=> $this->input->post('kd_lokasi'),'tgl_update'=> $this->input->post('tgl_update'),'no_peg_update'=> $this->input->post('no_peg_update'),'staf_kpl'=> $this->input->post('staf_kpl'),'sdn_lvl'=> $this->input->post('sdn_lvl'),'kd_group_grade_n'=> $this->input->post('kd_group_grade_n'),'corp_grade'=> $this->input->post('corp_grade'),'job_value'=> $this->input->post('job_value'),'kd_job_index_1'=> $this->input->post('kd_job_index_1'),'kd_job_index_2'=> $this->input->post('kd_job_index_2'),'kd_job_index_3'=> $this->input->post('kd_job_index_3'),'kd_job_index_4'=> $this->input->post('kd_job_index_4'),'nilai_ij_1'=> $this->input->post('nilai_ij_1'),'nilai_ij_2'=> $this->input->post('nilai_ij_2'),'nilai_ij_3'=> $this->input->post('nilai_ij_3'),'nilai_ij_4'=> $this->input->post('nilai_ij_4'),);;//array('nama'=>$this->input->post('nama'));
					$this->db->where('migrasi_jabatan_detail_id',$id);
					$this->db->update($this->table,$arr);
				}else{
					//save
					$arr=array('kd_jabatan'=> $this->input->post('kd_jabatan'),'ds_jabatan'=> $this->input->post('ds_jabatan'),'level_job'=> $this->input->post('level_job'),'detil'=> $this->input->post('detil'),'kd_jab_induk'=> $this->input->post('kd_jab_induk'),'kd_grp_job_profesi'=> $this->input->post('kd_grp_job_profesi'),'kd_group_grade'=> $this->input->post('kd_group_grade'),'ringkasan_jabatan'=> $this->input->post('ringkasan_jabatan'),'wewenang_jabatan'=> $this->input->post('wewenang_jabatan'),'kd_pendidikan'=> $this->input->post('kd_pendidikan'),'kd_jbt_pengalaman'=> $this->input->post('kd_jbt_pengalaman'),'lama_kd_jbt_pengalaman'=> $this->input->post('lama_kd_jbt_pengalaman'),'real_value'=> $this->input->post('real_value'),'kd_profesi'=> $this->input->post('kd_profesi'),'jab_aktif'=> $this->input->post('jab_aktif'),'periode_jab'=> $this->input->post('periode_jab'),'fung_struk'=> $this->input->post('fung_struk'),'kd_lokasi'=> $this->input->post('kd_lokasi'),'tgl_update'=> $this->input->post('tgl_update'),'no_peg_update'=> $this->input->post('no_peg_update'),'staf_kpl'=> $this->input->post('staf_kpl'),'sdn_lvl'=> $this->input->post('sdn_lvl'),'kd_group_grade_n'=> $this->input->post('kd_group_grade_n'),'corp_grade'=> $this->input->post('corp_grade'),'job_value'=> $this->input->post('job_value'),'kd_job_index_1'=> $this->input->post('kd_job_index_1'),'kd_job_index_2'=> $this->input->post('kd_job_index_2'),'kd_job_index_3'=> $this->input->post('kd_job_index_3'),'kd_job_index_4'=> $this->input->post('kd_job_index_4'),'nilai_ij_1'=> $this->input->post('nilai_ij_1'),'nilai_ij_2'=> $this->input->post('nilai_ij_2'),'nilai_ij_3'=> $this->input->post('nilai_ij_3'),'nilai_ij_4'=> $this->input->post('nilai_ij_4'),);;//array('kd_jabatan'=>$this->input->post('nama'));
