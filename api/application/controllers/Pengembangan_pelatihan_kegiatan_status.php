...
class Pengembangan_pelatihan_kegiatan_status extends REST_Controller
{
    ...
    public function delete_get()
    {
        ...
        if (array_key_exists('Authorization', $headers) && !empty($headers['Authorization'])) {
            ...
            if ($decodedToken != false) {
                ...
                $this->Pengembangan_pelatihan_kegiatan_status_model->delete($id);
    ...
    public function get_get()
    {
        ...
        $id = $this->input->get('id');
        $result = $this->Pengembangan_pelatihan_kegiatan_status_model->get_all(array("id" => $id), null, $offset, $limit);
